...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // Instantiate view model and view controller
        ...
        // Change Navigation Bar Appearance as per theme
        changeNavigationBarAppearance(navigationController: navigationController)

        // Make the window visible
        window?.makeKeyAndVisible()
    }

    func changeNavigationBarAppearance(navigationController: UINavigationController) {
        let appearance = UINavigationBarAppearance()
        appearance.configureWithOpaqueBackground()
        appearance.backgroundColor = Colors.themeColor
